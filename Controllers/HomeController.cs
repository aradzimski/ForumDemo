...
namespace ForumDemo.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, UserManager<IdentityUser> userManager, ForumRepository forumRepository, TopicRepository topicRepository, PostRepository postRepository)
        {
            _logger = logger;
